...
urlpatterns = [
    ...
    path('Customer/', views.customer_validation, name='customer_validation'),
...
#************************************API DATA URLS******************************************
    ...
    path('Dashboard/Mobile-Detected/', apiViews.get_mobile_detected_data, name='get_mobile_detected_data'),

    path('Dashboard/Multiple-People/', apiViews.get_multiple_people_data, name='get_multiple_people_data'),

    path('Dashboard/Unidentified-Person/', apiViews.get_unidentified_person_data, name='get_unidentified_person_data'),
    ...
    path('Dashboard/Mobile-Detected/Details/', views.mobile_detected_details_dashboard, name='mobile_detected_details_dashboard'),

    path('Dashboard/Multiple-People/Details/', views.multiple_people_details_dashboard, name='multiple_people_details_dashboard'),

    path('Dashboard/Unidentified-Person/Details/', views.unidentified_person_details_dashboard, name='unidentified_person_details_dashboard'),
    ...
    path('GetAgents/', views.get_agents, name='get_agents'),

# ******************  NOTIFICATIONS ******************8

    path('Notifications/', views.notification_list, name='notification_list'),

    path('Notifications/Current/', views.current_notifications, name='current_notifications'),

    path('Notifications/Old/', views.old_notifications, name='old_notifications'),

    path('Notifications/Details/<int:notification_id>/', views.view_notification, name='view_notification'),
    ...
    path('Notifications/Current/Data/', views.current_notifications_data, name='current_notifications_data'),

    path('Notifications/Old/Data/', views.old_notifications_data, name='old_notifications_data'),
    ...
    path('Admin/Agent/', views.agent_list, name='agent_list'),

    path('Admin/Agent/Add_Agent/', views.add_agent, name='add_agent'),

    path('Admin/Agent/Edit_Agent/<int:agent_id>/', views.edit_agent, name='edit_agent'),

    path('Admin/Agent/Add_Agent/Delete_Agent/<int:agent_id>/', views.delete_agent, name='delete_agent'),
